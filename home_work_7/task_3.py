...
class Cell:
    ...
    def __sub__(self, other):
        if self.cell >= other.cell:
            return f'Вычитание: {Cell(self.cell - other.cell)}'
        else:
            return 'Вычитание: Опреция не может быть выполнена!'

    def __mul__(self, other):
        return f'Умножение: {Cell(self.cell * other.cell)}'

    def __truediv__(self, other):
        return f'Целочисленное деление: {Cell(self.cell // other.cell)}'

    def make_order(self, quantity):
        result = ''
        divmod_number = divmod(self.cell, quantity)
        print(divmod_number)
        for i in range(divmod_number[0]):
            for i in range(quantity):
                result += '*'
            result += '\n'

        for i in range(divmod_number[1]):
            result += '*'
...
cell_1 = Cell(22)
cell_2 = Cell(20)
print(f'Клетка_1: {cell_1}, клетка_2: {cell_2}')
print(cell_1 + cell_2)
print(cell_1 - cell_2)
print(cell_1 * cell_2)
print(cell_1 / cell_2)
